Приложение позволяет работать с такими автоматными моделями, как машина Тьюринга (многоголовочная и многоленточная), автоматы на деревьях и древесные преобразователи, клеточные автоматы.
